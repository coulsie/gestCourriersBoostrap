                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-primary-subtle text-primary rounded-circle p-2 me-2 text-center"
                                                    ...
                                                    <div>
                                                        <div class="fw-bold text-dark">
                                                            @if ($absence->agent)
                                                                {{ $absence->agent->last_name }}
                                                                {{ $absence->agent->first_name }}
                                                            @else
                                                                <span class="badge bg-danger">ID #{{ $absence->agent_id }}
                                                                    non trouvé</span>
                                                            @endif
                                                        </div>
                                            ...
                                            <td>
                                                ...
                                                <span
                                                    class="badge bg-info-subtle text-info border border-info-subtle px-2 py-1 mb-1">
                                                ...
                                                @else
                                                    <small class="text-muted small italic">
                                                        <i class="fas fa-times-circle me-1 text-danger"></i>Sans
                                                        justificatif
                                                    </small>
                                                @endif
                                            </td>
                                            <td class="text-center">
                                                <div class="small fw-bold">
                                                    {{ \Carbon\Carbon::parse($absence->date_debut)->translatedFormat('d M Y') }}
                                                </div>
                                                <div class="text-muted small">au
                                                    {{ \Carbon\Carbon::parse($absence->date_fin)->translatedFormat('d M Y') }}
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-end">
                                                <div class="btn-group shadow-sm">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-outline-danger"
                                                        onclick="if(confirm('Supprimer cette absence ?')) document.getElementById('delete-{{ $absence->id }}').submit();"
                                                        title="Supprimer">
                                                        <i class="fas fa-trash"></i>
                                                    </button>
                                                </div>
                                                <form id="delete-{{ $absence->id }}"
                                                    action="{{ route('absences.destroy', $absence->id) }}" method="POST"
                                                    class="d-none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
